...
module Queue8_GpuCommandResult(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  input  [3:0]  io_enq_bits_status,	// src/main/scala/chisel3/util/Queue.scala:72:14
  input         io_enq_bits_success,	// src/main/scala/chisel3/util/Queue.scala:72:14
  input  [63:0] io_enq_bits_bytesProcessed,	// src/main/scala/chisel3/util/Queue.scala:72:14
  ...
  output [3:0]  io_deq_bits_status,	// src/main/scala/chisel3/util/Queue.scala:72:14
  output        io_deq_bits_success,	// src/main/scala/chisel3/util/Queue.scala:72:14
  output [63:0] io_deq_bits_bytesProcessed	// src/main/scala/chisel3/util/Queue.scala:72:14
);

  wire [75:0] _ram_ext_R0_data;	// src/main/scala/chisel3/util/Queue.scala:73:91
  ...
  ram_8x76 ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:91
    ...
    .W0_data
      ({io_enq_bits_commandId,
        ...
        io_enq_bits_status,
        io_enq_bits_success,
        io_enq_bits_bytesProcessed})	// src/main/scala/chisel3/util/Queue.scala:73:91
  ...
  assign io_deq_bits_commandId = _ram_ext_R0_data[75:72];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_opcode = _ram_ext_R0_data[71:69];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_status = _ram_ext_R0_data[68:65];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_success = _ram_ext_R0_data[64];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_bytesProcessed = _ram_ext_R0_data[63:0];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
endmodule
