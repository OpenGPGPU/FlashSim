...
module RRArbiter4_OmMemoryRequest(	// src/main/scala/chisel3/util/Arbiter.scala:127:7
  ...
  input         io_in_0_valid,	// src/main/scala/chisel3/util/Arbiter.scala:52:14
                io_in_0_bits_write,	// src/main/scala/chisel3/util/Arbiter.scala:52:14
  ...
  input         io_in_1_valid,	// src/main/scala/chisel3/util/Arbiter.scala:52:14
                io_in_1_bits_write,	// src/main/scala/chisel3/util/Arbiter.scala:52:14
  ...
  input         io_in_2_valid,	// src/main/scala/chisel3/util/Arbiter.scala:52:14
                io_in_2_bits_write,	// src/main/scala/chisel3/util/Arbiter.scala:52:14
  ...
  input         io_in_3_valid,	// src/main/scala/chisel3/util/Arbiter.scala:52:14
                io_in_3_bits_write,	// src/main/scala/chisel3/util/Arbiter.scala:52:14
  ...
  output        io_out_valid,	// src/main/scala/chisel3/util/Arbiter.scala:52:14
                io_out_bits_write,	// src/main/scala/chisel3/util/Arbiter.scala:52:14
  ...
  always_comb begin	// src/main/scala/chisel3/util/Arbiter.scala:55:16
    casez (io_chosen_choice)	// src/main/scala/chisel3/util/Arbiter.scala:55:16, :102:{24,33}
      2'b00:
        casez_tmp_0 = io_in_0_bits_write;	// src/main/scala/chisel3/util/Arbiter.scala:55:16
      2'b01:
        casez_tmp_0 = io_in_1_bits_write;	// src/main/scala/chisel3/util/Arbiter.scala:55:16
      2'b10:
        casez_tmp_0 = io_in_2_bits_write;	// src/main/scala/chisel3/util/Arbiter.scala:55:16
      default:
        casez_tmp_0 = io_in_3_bits_write;	// src/main/scala/chisel3/util/Arbiter.scala:55:16
    endcase	// src/main/scala/chisel3/util/Arbiter.scala:55:16, :102:{24,33}
  end // always_comb
  ...
  always_comb begin	// src/main/scala/chisel3/util/Arbiter.scala:55:16
    casez (io_chosen_choice)	// src/main/scala/chisel3/util/Arbiter.scala:55:16, :102:{24,33}
      2'b00:
        casez_tmp_1 = io_in_0_bits_addr;	// src/main/scala/chisel3/util/Arbiter.scala:55:16
      2'b01:
        casez_tmp_1 = io_in_1_bits_addr;	// src/main/scala/chisel3/util/Arbiter.scala:55:16
      2'b10:
        casez_tmp_1 = io_in_2_bits_addr;	// src/main/scala/chisel3/util/Arbiter.scala:55:16
      default:
        casez_tmp_1 = io_in_3_bits_addr;	// src/main/scala/chisel3/util/Arbiter.scala:55:16
    endcase	// src/main/scala/chisel3/util/Arbiter.scala:55:16, :102:{24,33}
  end // always_comb
  ...
  always_comb begin	// src/main/scala/chisel3/util/Arbiter.scala:55:16
    casez (io_chosen_choice)	// src/main/scala/chisel3/util/Arbiter.scala:55:16, :102:{24,33}
      2'b00:
        casez_tmp_2 = io_in_0_bits_data;	// src/main/scala/chisel3/util/Arbiter.scala:55:16
      2'b01:
        casez_tmp_2 = io_in_1_bits_data;	// src/main/scala/chisel3/util/Arbiter.scala:55:16
      2'b10:
        casez_tmp_2 = io_in_2_bits_data;	// src/main/scala/chisel3/util/Arbiter.scala:55:16
      default:
        casez_tmp_2 = io_in_3_bits_data;	// src/main/scala/chisel3/util/Arbiter.scala:55:16
    endcase	// src/main/scala/chisel3/util/Arbiter.scala:55:16, :102:{24,33}
  end // always_comb
  ...
  assign io_out_bits_write = casez_tmp_0;	// src/main/scala/chisel3/util/Arbiter.scala:55:16, :127:7
  assign io_out_bits_addr = casez_tmp_1;	// src/main/scala/chisel3/util/Arbiter.scala:55:16, :127:7
  assign io_out_bits_data = casez_tmp_2;	// src/main/scala/chisel3/util/Arbiter.scala:55:16, :127:7
endmodule
