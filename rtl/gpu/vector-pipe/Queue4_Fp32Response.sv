...
module Queue4_Fp32Response(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  input  [6:0]  io_enq_bits_tag,	// src/main/scala/chisel3/util/Queue.scala:72:14
  ...
  ram_4x37 ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:91
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_result, io_enq_bits_status})	// src/main/scala/chisel3/util/Queue.scala:73:91
  ...
  assign io_deq_bits_result = _ram_ext_R0_data[36:5];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_status = _ram_ext_R0_data[4:0];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
endmodule
