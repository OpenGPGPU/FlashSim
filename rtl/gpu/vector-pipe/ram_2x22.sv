...
module ram_2x22(	// src/main/scala/chisel3/util/Queue.scala:73:91
  input         R0_addr,
                R0_en,
                R0_clk,
  output [21:0] R0_data,
  ...
  reg [21:0] Memory[0:1];	// src/main/scala/chisel3/util/Queue.scala:73:91
    ...
    initial begin	// src/main/scala/chisel3/util/Queue.scala:73:91
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chisel3/util/Queue.scala:73:91
        for (logic [1:0] i = 2'h0; i < 2'h2; i += 2'h1) begin
          ...
          Memory[i[0]] = _RANDOM_MEM[21:0];	// src/main/scala/chisel3/util/Queue.scala:73:91
        end
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
  assign R0_data = R0_en ? Memory[R0_addr] : 22'bx;	// src/main/scala/chisel3/util/Queue.scala:73:91
endmodule
