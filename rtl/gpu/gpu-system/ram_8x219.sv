...
module ram_8x219(	// src/main/scala/chisel3/util/Queue.scala:73:91
  input  [2:0]   R0_addr,
  input          R0_en,
                 R0_clk,
  ...
  reg [218:0] Memory[0:7];	// src/main/scala/chisel3/util/Queue.scala:73:91
    ...
    initial begin	// src/main/scala/chisel3/util/Queue.scala:73:91
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chisel3/util/Queue.scala:73:91
        for (logic [3:0] i = 4'h0; i < 4'h8; i += 4'h1) begin
          ...
          Memory[i[2:0]] = _RANDOM_MEM[218:0];	// src/main/scala/chisel3/util/Queue.scala:73:91
        end
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
  assign R0_data = R0_en ? Memory[R0_addr] : 219'bx;	// src/main/scala/chisel3/util/Queue.scala:73:91
endmodule
