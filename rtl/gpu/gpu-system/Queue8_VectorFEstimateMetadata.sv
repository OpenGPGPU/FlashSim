...
module Queue8_VectorFEstimateMetadata(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  input  [3:0]  io_enq_bits_warpActiveMask,	// src/main/scala/chisel3/util/Queue.scala:72:14
  input  [4:0]  io_enq_bits_vd,	// src/main/scala/chisel3/util/Queue.scala:72:14
  input  [3:0]  io_enq_bits_enabled,	// src/main/scala/chisel3/util/Queue.scala:72:14
  input  [31:0] io_enq_bits_oldVd_0,	// src/main/scala/chisel3/util/Queue.scala:72:14
                io_enq_bits_oldVd_1,	// src/main/scala/chisel3/util/Queue.scala:72:14
                io_enq_bits_oldVd_2,	// src/main/scala/chisel3/util/Queue.scala:72:14
                io_enq_bits_oldVd_3,	// src/main/scala/chisel3/util/Queue.scala:72:14
  ...
  output [3:0]  io_deq_bits_warpActiveMask,	// src/main/scala/chisel3/util/Queue.scala:72:14
  output [4:0]  io_deq_bits_vd,	// src/main/scala/chisel3/util/Queue.scala:72:14
  output [3:0]  io_deq_bits_enabled,	// src/main/scala/chisel3/util/Queue.scala:72:14
  output [31:0] io_deq_bits_oldVd_0,	// src/main/scala/chisel3/util/Queue.scala:72:14
                io_deq_bits_oldVd_1,	// src/main/scala/chisel3/util/Queue.scala:72:14
                io_deq_bits_oldVd_2,	// src/main/scala/chisel3/util/Queue.scala:72:14
                io_deq_bits_oldVd_3	// src/main/scala/chisel3/util/Queue.scala:72:14
);

  wire [174:0] _ram_ext_R0_data;	// src/main/scala/chisel3/util/Queue.scala:73:91
  ...
  ram_8x175 ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:91
    ...
    .W0_data
      ({io_enq_bits_warpId,
        io_enq_bits_pc,
        io_enq_bits_warpActiveMask,
        io_enq_bits_vd,
        io_enq_bits_enabled,
        io_enq_bits_oldVd_3,
        io_enq_bits_oldVd_2,
        io_enq_bits_oldVd_1,
        io_enq_bits_oldVd_0})	// src/main/scala/chisel3/util/Queue.scala:73:91
  ...
  assign io_deq_bits_warpId = _ram_ext_R0_data[174:173];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_pc = _ram_ext_R0_data[172:141];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_warpActiveMask = _ram_ext_R0_data[140:137];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_vd = _ram_ext_R0_data[136:132];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_enabled = _ram_ext_R0_data[131:128];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_oldVd_0 = _ram_ext_R0_data[31:0];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_oldVd_1 = _ram_ext_R0_data[63:32];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_oldVd_2 = _ram_ext_R0_data[95:64];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_oldVd_3 = _ram_ext_R0_data[127:96];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
endmodule
