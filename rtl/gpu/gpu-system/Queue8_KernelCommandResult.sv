...
module Queue8_KernelCommandResult(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  input  [2:0] io_enq_bits_status,	// src/main/scala/chisel3/util/Queue.scala:72:14
  ...
  output [2:0] io_deq_bits_status,	// src/main/scala/chisel3/util/Queue.scala:72:14
  output       io_deq_bits_success	// src/main/scala/chisel3/util/Queue.scala:72:14
);

  wire [7:0] _ram_ext_R0_data;	// src/main/scala/chisel3/util/Queue.scala:73:91
  ...
  ram_8x8 ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:91
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_commandId, io_enq_bits_status, io_enq_bits_success})	// src/main/scala/chisel3/util/Queue.scala:73:91
  ...
  assign io_deq_bits_commandId = _ram_ext_R0_data[7:4];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_status = _ram_ext_R0_data[3:1];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_success = _ram_ext_R0_data[0];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
endmodule
