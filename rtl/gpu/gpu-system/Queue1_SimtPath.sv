...
module Queue1_SimtPath(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  reg  [37:0] ram;	// src/main/scala/chisel3/util/Queue.scala:73:91
  ...
  always @(posedge clock) begin	// src/main/scala/chisel3/util/Queue.scala:60:7
    ...
    if (do_enq)	// src/main/scala/chisel3/util/ReadyValidIO.scala:48:35
      ram <= {io_enq_bits_warpId, io_enq_bits_pc, io_enq_bits_activeMask};	// src/main/scala/chisel3/util/Queue.scala:73:91
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/chisel3/util/Queue.scala:60:7
    ...
    logic [31:0] _RANDOM[0:1];	// src/main/scala/chisel3/util/Queue.scala:60:7
    initial begin	// src/main/scala/chisel3/util/Queue.scala:60:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/chisel3/util/Queue.scala:60:7
        ...
        ram = {_RANDOM[1'h0][31:1], _RANDOM[1'h1][6:0]};	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91, :76:27
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_deq_bits_warpId = ram[37:36];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_pc = ram[35:4];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
  assign io_deq_bits_activeMask = ram[3:0];	// src/main/scala/chisel3/util/Queue.scala:60:7, :73:91
endmodule
